  ...
  <NuxtLayout name="auth">
    ...
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold">Réinitialisation Admin</h1>
        <p class="text-[var(--color-text-secondary)] mt-2">Créez votre nouveau mot de passe administrateur</p>
      </div>
        ...
        <form v-else @submit.prevent="handleReset" class="space-y-4">
          ...
          <div
            ...
            <p class="text-xs text-blue-600 dark:text-blue-400 leading-relaxed">
              Le mot de passe doit contenir au moins 12 caractères, avec 2 majuscules, 2 minuscules, 2 chiffres et 2
              caractères spéciaux.
            </p>
          </div>
...
// SEO
useHead({
  title: 'Réinitialisation Admin',
  meta: [
    {
      name: 'description',
      content: "Réinitialisez votre mot de passe administrateur CyberIncub."
    }
  ]
});
